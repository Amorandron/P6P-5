                    ...
                    if (mm.matches()) {
                        ...
                        do {
                            ...
                            if (sm.matches()) {
                                ...
                                writer.println(String.join(DELIMITER, addQuotes(currentMovieTitle), currentMovieYear, addQuotes(currentType), currentRomanNumber, addQuotes(currentSong.replace(QUOTE, DOUBLE_QUOTE))));
                            }
